...
class _SexeFormState extends State<SexeForm> {
  ...
  onPressed: () {
    if (_selectedGender.isNotEmpty) {
      // Assign the selected gender to the global variable
      globals.sexe = _selectedGender;
      print("Selected gender: ${globals.sexe}"); // Print to confirm assignment
    }

    // Navigate to the YearOfBirthForm
    Navigator.push(
      context,
