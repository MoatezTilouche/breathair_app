...
class _RaisonFormState extends State<RaisonForm> {
  String? _selectedReason; // Changed to a single string
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (_selectedReason != null) {
                        // Assign the selected reason to the global variable
                        globals.raisonstopsmoking = [_selectedReason!];

                        // Print to confirm the assignment
                        print("Selected Reason: ${globals.raisonstopsmoking}");
  ...
  Widget _buildReasonOption(String reason) {
    bool isSelected =
        _selectedReason == reason; // Check if the reason is selected

    return GestureDetector(
      onTap: () {
        setState(() {
          // Select the reason (only one can be selected)
