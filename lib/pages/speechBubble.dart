...
class SpeechBubblePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width - 5, size.height, size.width - 10, size.height - 20); // Bottom-right curve
    path.lineTo(size.width - 10, 20); // Right side
    path.quadraticBezierTo(size.width - 5, 0, size.width - 30, 0); // Top-right curve
